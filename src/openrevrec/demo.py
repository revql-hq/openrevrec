...
def demo_commands():
    ...
    contracts = [
        ...
        {"id": "con_usage", "name": "Usage-based processing", "customer_id": "cus_evergreen", "start_date": "2026-09-01", "end_date": "2026-12-31", "consideration": [price("10000.00", "Committed processing capacity")], "obligations": [consumption], "rationale": "Fixed committed consideration is satisfied by units delivered; invoicing follows separately."},
